...
/**
 * Solidity Contract Template based on Corruption(s*) by @dhof
 * Source: https://etherscan.io/address/0x5bdf397bb2912859dbd8011f320a222f79a28d2e
 *
...
contract Corruptions is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    returns (string memory)
  {
    ...
    return
      ICorruptionsMetadata(metadataAddress).tokenURI(tokenID, insight(tokenID));
  }
  ...
  function transferFrom(
    ...
    address to,
    uint256 tokenId
  ) public override onlyWhenTradable {
  ...
  function EXPERIMENTAL_UNAUDITED_NO_ROADMAP_ABSOLUTELY_NO_PROMISES_BUT_I_ACKNOWLEDGE_AND_WANT_TO_MINT_ANYWAY()
    public
    payable
    nonReentrant
  {
